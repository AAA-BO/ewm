    ...
    layui.use('layer', function () {
        ...
        var tableIns = table.render({
            ...
            */
            ...
            , page: true //开启分页
            , cols: [[ //表头
                {type: 'checkbox', width: 30, fixed: 'left'}// 全选： LAY_CHECKED: true
        ...
        //监听工具栏中的所有元素的所有事件(传入table对象的filter)
                ...
                case 'delete':
                    ...
                    layer.confirm('确认要删除选中的行吗？', {icon: 3, title: '警告'}, function (index) {
                        ...
                        for (data_index in checkStatus.data) {
                            console.log(checkStatus.data[data_index].id);
                            deleteIds.push(checkStatus.data[data_index].id);
                        }
