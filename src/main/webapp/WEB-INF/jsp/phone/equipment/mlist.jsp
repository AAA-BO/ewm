...
<div class="bui-page">
    <header class="bui-bar">
        ...
        <div class="bui-bar-main">维护组</div>
    ...
    <main>
        ...
        <ul class="bui-list personal-info">
            <s:iterator value="#request.maintainGroups" var="maintainGroup">
                <li class="bui-btn bui-box" onclick="to('/maintainGroup_phone_home','${maintainGroup.oid}');">
                    <div class="span1">
                        <div class="photo-info">
                            <h3 class="photo-title">${maintainGroup.name}
                                <div class="photo-desc">
                                    <span class="time">说明：${maintainGroup.info}</span>
                                </div>
                            </h3>
                        </div>
                    </div>
