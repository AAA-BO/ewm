...
<body class="layui-layout-body">
    ...
    <div>
        ...
        <script type="text/html" id="mainTool">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-sm" lay-event="equipment">管理设备</button>
                <button class="layui-btn layui-btn-sm" lay-event="record">维护记录</button>
            </div>
        </script>
    </div>
    ...
    layui.use('layer', function () {
        ...
        var tableIns = table.render({
            ...
            */
            ...
            ,limits:[1,2,10,20]
            , cols: [[ //表头
                {type: 'checkbox', width: 30}// 全选： LAY_CHECKED: true , fixed: 'left'
                , {field: 'oid', title: 'ID',  sort: true}//, fixed: 'left'  width: 80,
                , {field: 'name', title: '姓名',  sort: true}//,edit:'true' width: 80,
