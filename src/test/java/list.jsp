...
<body class="layui-layout-body">
    ...
    <div>
        ...
        <script type="text/html" id="mainTool">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-sm" lay-event="equipment">所有员工</button>
                <button class="layui-btn layui-btn-sm" lay-event="record">所有设备</button>
